...
describe('default behavior', () => {
  describe('application menu', () => {
    it('does create default menu if the app does not set it', async () => {
      const result = await runTestApp('default-menu')
      expect(result).to.equal(false)
    })

    it('does not create default menu if the app does set it', async () => {
  ...
  describe('window-all-closed', () => {
    it('does quit when the app does not handle the event', async () => {
      const result = await runTestApp('window-all-closed')
      expect(result).to.equal(false)
    })

    it('does not quit when the app does handle the event', async () => {
